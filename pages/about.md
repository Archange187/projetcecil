  ...
  <div class="container">
    <div class="hero-content">
      <div class="hero-text">
        ...
        <h1><strong>Archange Nyondo </strong></h1>
      ...
      <div class="hero-image">
        <div class="photo-container">
          <img src="../static/images/archange.JPG" alt="Photo de Archange" class="photo-profil">
        </div>
      </div>
    </div>
  </div>
...
<section class="cta" id="contact">
  <div class="container">
    ...
    <div class="cta-buttons">
      <a href="mailto:archangenyondo6@gmail.com" class="btn btn-primary">
        <i class="fas fa-envelope"></i>
        M'envoyer un email
      </a>
      <a href="https://github.com/Archange187" class="btn btn-secondary" target="_blank">
